ApplicasterApp demo application that shows a simple filterable list with 2 types of items (link and video). Link opens in WebView, video URL plays in Video Player. 
